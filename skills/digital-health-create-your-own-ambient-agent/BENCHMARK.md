...
Evaluation of the `digital-health-create-your-own-ambient-agent` skill before publication through NVSkills-Eval.
...
| Correctness | 5 | 100% (+38%) | 97% (+27%) |
| Discoverability | 5 | 100% (+43%) | 94% (+23%) |
| Effectiveness | 5 | 98% (+39%) | 98% (+32%) |
| Efficiency | 5 | 94% (+36%) | 88% (+18%) |
...
- LOW SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/digital-health-create-your-own-ambient-agent/SKILL.md`)
